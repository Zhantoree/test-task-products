...
export const Card: FC<CardProps> = memo(({product, amount, addToCart, removeFromCart, changeAmount}) => {
    ...
    return <div key={product.id} className="flex flex-col justify-start p-2 bg-grey-300 rounded-xl">
            ...
            product?.id && (
                amount ? (
                    <div className="flex justify-center gap-1">
                        ...
                        <input
                            className="w-full my-2 max-w-[150] bg-grey-500 text-white py-3 rounded-xl"
                            type={'number'}
                            value={amount}
                            min={1}
